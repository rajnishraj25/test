...
const NoWorry = () => {
  return (
    <div className="w-full h-[716px] bg-btnwhite">
      <div className="container w-full h-full px-24 py-[128px]">
        <h3 className="text-center text-black font-ppright text-[82px] font-medium leading-[82px] tracking-[-4px]">
          Don't think you’re span fit for an IIT? <br /> Worry no more!
        </h3>
        <p className="inter text-black font-medium text-[28px] leading-[29px] tracking-[-1px] mt-6 text-center">
        ...
        <div>
          <div className="flex items-center justify-center mt-8">
            ...
            <div className="w-[475px] h-[2px] bg-yello"></div>
            <div className="w-6 h-6 rounded-full bg-yello"></div>
            <div className="w-[475px] h-[2px] bg-yello"></div>
            <div className="w-6 h-6 rounded-full bg-yello"></div>
          </div>
